...
import static com.noida.just200.R.id.btn_sendhelprecord_reset;

public class SendHelpRecordActivity extends AppCompatActivity {
    ProgressDialog pd;
    ...
    Button btn_sendhelprecord,btn_sendhelprecord_resets;
    ArrayList<SendHelpRecordData> sendHelpRecordDatas = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_help_record);
       ...
       cal = Calendar.getInstance();
        ...
        lst_sendhelprecords=(ListView)findViewById(R.id.lst_sendhelprecords);

        edt_amout=(EditText)findViewById(R.id.edt_amount_send);
        btn_sendhelprecord=(Button)findViewById(R.id.btn_sendhelprecord) ;
        btn_sendhelprecord_resets=(Button)findViewById(btn_sendhelprecord_reset);
        fromdate =(EditText)findViewById(R.id.edt_select_fromdate_send);
        todate =(EditText)findViewById(R.id.edt_select_todate_send);
      ...
      final   String loginID= map.get(SessionManager.KEY_LOGINID);
        ...
        btn_sendhelprecord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              String Url ="http://api.just200.in/Just200Panel.svc/SendHelpReports/"+loginID+"/"+fromdates+"/"+todates+"/"+amount+"/1/100";
                 showProgressDialog();
                PostSendHelpRecords(Url);
            }
        });

        btn_sendhelprecord_resets.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fromdate.setText("");
                todate.setText("");
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jArray.length(); i++) {
                                ...
                                sendHelpRecordDatas.add(new SendHelpRecordData(sno,id,name, amout,TransactionID,TransactionDate, status)) ;


                                }
                            if (APIResponcesenderhelprecord.equals("Success")) {
                                sendhelpRecordAdapter arrayAdapter = new sendhelpRecordAdapter(SendHelpRecordActivity.this, R.layout.sendhelprecord_activity_adapter, sendHelpRecordDatas);
    ...
    private class sendhelpRecordAdapter extends ArrayAdapter {
        private ArrayList<SendHelpRecordData> getsendhelpDataArrayList;
        ...
        public sendhelpRecordAdapter(Context context, int resource, ArrayList<SendHelpRecordData> getsendhelpDataArrayList) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            SendHelpRecordData sendHelpRecordDatasss = sendHelpRecordDatas.get(position);
